...
# "glyph" is a motif identifier (not a literal character) — index.html's
# emblemSVG() renders it as a small geometric mandala icon per archetype.
ARCHETYPES = [
    dict(key="shadow", name="Shadow", glyph="eclipse", color="#a97c54",
         ...
         variants=["shadow"]),
    dict(key="healer", name="Wounded Healer", glyph="petals", color="#92a35c",
    ...
    dict(key="trickster", name="Trickster", glyph="blades", color="#d1a23e",
         blurb="The rule-breaker and shapeshifter. Syncopated, genre-bending, unpredictable music that refuses to be categorized.",
         variants=["trickster"]),
    dict(key="lover", name="Lover / Anima", glyph="vesica", color="#d97a52",
    ...
    dict(key="sage", name="Sage", glyph="rings", color="#7fa3b8",
    ...
    dict(key="explorer", name="Explorer", glyph="compass", color="#4fa39a",
